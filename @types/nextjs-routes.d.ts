...
declare module "nextjs-routes" {
  ...
  export type Route =
    ...
    | StaticRoute<"/api/graphql-proxy">
    | StaticRoute<"/api/recaptchaSubmit">
    | StaticRoute<"/auth/signin">
    | StaticRoute<"/auth/verify-request">
    | StaticRoute<"/data">
    | DynamicRoute<"/data/tables/[table_name]", { "table_name": string }>
    | StaticRoute<"/feedback/_Feedback">
    | StaticRoute<"/feedback">
    | DynamicRoute<"/ia/[iaNumber]", { "iaNumber": string }>
    | StaticRoute<"/">
    | DynamicRoute<"/profile/[bpiId]", { "bpiId": string }>
