	...
	return (
		<div className={"w-full h-fit py-[50px] flex flex-col text-white justify-center px-[200px]"}>
			<span className={"w-full flex items-start flex-col gap-[50px] py-[50px]"}>
				<p className={"text-[128px] leading-[100px] font-bold"}>About</p>
				<p className={"font-regular text-3xl leading-[40px]"}>
				...
				<div className={"w-full flex flex-row gap-4"}>
					...
					<p className={"w-3/5 text-[25px] leading-[35px] font-regular"}>
			...
			<span className={"w-full flex items-start flex-col gap-[50px] py-[50px]"}>
				<p className={"text-[128px] leading-[100px] font-bold"}>Data Sources</p>
				<p className={"font-regular text-3xl leading-[40px]"}>
			...
			<span className={"w-full flex items-start flex-col gap-[50px] py-[50px]"}>
				<p className={"text-[128px] leading-[100px] font-bold"}>Contributors</p>
